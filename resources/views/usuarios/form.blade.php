                ...
                <div class="row">
                    ...
                    <div class="elementos_estado">
                        ...
                        <div id="soltero">
                         ...
                         <div id="casado">
                                <button type="button" name="add" id="addCasado" class="btn btn-sm btn-success">+</button>
                             <div class="row" style="border: solid 1px black; padding:11px">
                                    <div class="col-md-4" >
                                        <div class="input-group flex-nowrap">
                                            <div class="input-group-prepend">
                                    ...
                                    <div class="col-md-4" >
                                            <div class="input-group flex-nowrap">
                                                ...
                                                <input type="text" class="form-control" name="primero_coy" id="primero_coy" placeholder="Apellido Paterno" aria-label="Apellido Materno" aria-describedby="addon-wrapping">
                                            </div>
                                    </div>
                                    ...
                                    <div class="col-md-4" >
                                            <div class="input-group flex-nowrap">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="addon-wrapping">Materno</span>
                                                </div>
                                                <input type="text" class="form-control" name="segundo_coy" id="segundo_coy" placeholder="Apellido Materno" aria-label="Apellido Materno" aria-describedby="addon-wrapping">
                                            </div>
                                    </div>
                                    ...
                                    <div class="col-md-4" >
                                            <div class="input-group flex-nowrap">
                                                ...
                                                <input type="text" class="form-control" name="calle" id="curp_coy" placeholder="Curp" aria-label="Curp" aria-describedby="addon-wrapping">
                                            </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                            <div class="input-group flex-nowrap">
                                                    <div class="input-group-prepend">
                                                        ...
                                                        <div class="custom-file">
                                                        <input type="file" class="custom-file-input" name="carga_curp_coy" id="inputGroupFileAddon01"  aria-describedby="inputGroupFileAddon01">
                                                        <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                                                    </div>
                                            </div>
                                        </div>
